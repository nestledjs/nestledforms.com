export const navigation = [
  ...
  },
  {
    title: 'Web Forms',
    links: [
      { title: 'Text fields', href: '/docs/web/text-fields' },
  ...
  },
  {
    title: 'Native Forms',
    links: [
      { title: 'Overview', href: '/docs/native/overview' },
      { title: 'Field differences', href: '/docs/native/field-differences' },
    ],
  },
  {
    title: 'Advanced',
    links: [
      ...
      { title: 'Apollo integration', href: '/docs/apollo-integration' },
