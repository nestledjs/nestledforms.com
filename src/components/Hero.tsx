...
const declarativeCode = `import { Form, FormFieldClass } from '@nestledjs/forms'
...
<Form id="signup" fields={fields}
  submit={(values) => console.log(values)}>
  <button type="submit">Submit</button>
</Form>`

const imperativeCode = `import { Form, RenderFormField,
  FormFieldClass } from '@nestledjs/forms'
...
const tabs = [
  { name: 'declarative.tsx', language: 'tsx', code: declarativeCode },
  { name: 'imperative.tsx', language: 'tsx', code: imperativeCode },
]
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-linear-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Type-safe forms for React and React Native.
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                24+ field types. Declarative or imperative. Conditional logic,
                validation, theming, and Apollo GraphQL — all built in.
              </p>
